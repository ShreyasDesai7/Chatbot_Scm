...
if not api_key:
    ...
    api_key = "AIzaSyAEw6qi0tCQga2cntcAPzsbqibGirsHa2M"
    st.warning("Using hardcoded API key for testing. Please set GOOGLE_API_KEY in environment variables for production.")
